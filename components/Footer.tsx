...
const Footer = () => {
  return (
    <div className='bg-black py-10 items-center flex flex-col padding-x'>
      ...
      <hr className='h-[2px] rounded-sm my-8 w-full bg-white border-0' />
      <div className='flex justify-start w-full text-white gap-10'>
        <div>
